...
const SmumLogo = forwardRef(function SmumLogo(
  { className = "", style, width, height, display, ...svgProps },
  ref
) {
  ...
  return (
    <svg
      ...
      {...svgProps}
    >
            {/* --- your SVG content unchanged, shortened here --- */}
...
export default SmumLogo;

// import React from 'react';
// // import { Box } from '@mui/material';

// export default function SmumLogo({ className = "", width, height, display }) {
    
//     const opacity = (display === "solid") ? "1.0" : "0.6"
//     const padding = (display === "solid") ? 0 : 5

//     return (
//         <div className={ className } style={{ paddingLeft: padding }}>
