...
// <name> and <domain> cannot start with . or -
...
export function Register(props) {
    ...
    function validateForm() {
        ...
        if (telephone) {
            ...
            if (numbers.length != 10 || numbers.charAt(0) == "0" || numbers.charAt(0) == "1") {
                return {ready: false, message: t('errPhone')};
            }
        }
        if (email && !emailRegex.test(email)) {
            return {ready: false, message: t('errEmail')};
        }
        return {ready: true, message: ""};
    }

    if (regStep == 0) {
        const {ready, message} = validateForm();
        return (
            <>
